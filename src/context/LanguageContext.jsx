...
export const translations = {
  uz: {
    ...
    hero: {
      ...
      desc: "Cmech Premium Thermo — zamonaviy me'morchilik va nozik estetika chorrahasida yaratilgan nemis standartidagi alyuminiy eshik va rom tizimlari.",
    ...
    philosophy: {
      ...
      card1Title: "Nemis Standart Injiniringi",
  ...
  ru: {
    ...
    hero: {
      ...
      desc: "Cmech Premium Thermo — оконно-дверные системы из алюминия немецкого стандарта, созданные на стыке современной архитектуры и эстетики.",
  ...
  en: {
    ...
    hero: {
      ...
      desc: "Cmech Premium Thermo — German-engineered aluminum door and window systems designed at the intersection of modern architecture and luxury aesthetics.",
    ...
    philosophy: {
      ...
      card1Title: "German Engineering Standards",
